#################################################
# HelloID-Conn-Prov-Target-Microsoft-Exchange-Online-Permissions-Groups-Grant
...
try {
    ...
    if (-Not($actionContext.DryRun -eq $true)) {
        ...
        $grantedPermission = Add-DistributionGroupMember @grantPermissionSplatParams
    ...
    if ($auditMessage -like "*Microsoft.Exchange.Management.Tasks.MemberAlreadyExistsException*") {
        $outputContext.AuditLogs.Add([PSCustomObject]@{
                # Action  = "" # Optional
